...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white overflow-x-hidden">
      <nav className="fixed w-full z-50 bg-[#000000]/98 backdrop-blur-xl border-b border-cyan-500/10">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-[#0a0a0a] border-t border-cyan-500/10">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 bg-gradient-to-br from-[#000000] via-[#0a0a1f] to-[#000000]">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-[#000000] via-[#0a0a1f] to-[#000000] overflow-hidden relative">
        ...
        <div className="relative z-10 group">
          ...
          >
            {[...reels, ...reels].map((reel, idx) => (
              ...
              >
                <video
                  ref={el => videoRefs.current[`reel-${idx}`] = el}
                  src={reel.videoUrl}
        ...
        {selectedVideo && (
          ...
          >
            ...
            >
              ...
              <div className="bg-[#0a0a0a] rounded-2xl overflow-hidden border-2 border-cyan-400 shadow-2xl shadow-cyan-500/50">
                <video
        ...
        <div className="max-w-7xl mx-auto mt-20 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-[#0a0a0a] rounded-xl p-6 border border-cyan-500/20 hover:border-cyan-400/50 transition text-center">
      ...
      <section id="services" className="py-20 px-4 bg-gradient-to-b from-[#0a0a1f] via-[#000000] to-[#0a0a1f] relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            {services.slice(0, 3).map((service, idx) => (
              <div 
                key={idx}
                className="bg-[#000000] rounded-2xl p-6 border border-cyan-500/20 hover:border-cyan-400 transition-all duration-300 group cursor-pointer hover:transform hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/20"
              >
          ...
          <div className="relative group/services">
            ...
            >
              {[...services.slice(3), ...services.slice(3)].map((service, idx) => (
                <div 
                  key={idx}
                  className="bg-[#000000] rounded-2xl p-6 border border-cyan-500/20 hover:border-cyan-400 transition-all duration-300 group/card cursor-pointer hover:transform hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/20 flex-shrink-0"
                  style={{ width: '350px' }}
                >
      ...
      <section id="portfolio" className="py-20 px-4 bg-gradient-to-b from-[#000000] via-[#0a0a1f] to-[#000000] relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
            ...
            {portfolio.map((project, idx) => (
              ...
              >
                <div className="aspect-video overflow-hidden relative">
                  <video
                    ref={el => videoRefs.current[`portfolio-${idx}`] = el}
      ...
      <section id="testimonials" className="py-20 px-4 bg-gradient-to-b from-[#0a0a1f] via-[#000000] to-[#0a0a1f] relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, idx) => (
              <div 
                key={idx}
                className="bg-[#000000] rounded-2xl p-8 border border-cyan-500/20 hover:border-cyan-400 transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/20"
              >
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-[#000000] via-[#0a0a1f] to-[#000000] relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="bg-[#0a0a0a] rounded-3xl p-12 border-2 border-cyan-400/50 backdrop-blur-sm relative overflow-hidden">
      ...
      <footer className="py-12 px-4 bg-[#000000] border-t border-cyan-500/10">
